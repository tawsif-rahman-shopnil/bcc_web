                ...
                <div class="col-md-6 ">
                    ...
                    <ul class="ulright">
                       <li> <small>Folow Us </small>:</li>
                        <li>
                            <a href="https://www.facebook.com/baiustcomputerclub"><i class="fab fa-facebook-square"></i>
                        </li>
                        <li>
                            <a href="https://twitter.com/baiustcomclub"><i class="fab fa-twitter-square"></i>
                        </li>
                        <li>
                            <a href="https://www.linkedin.com/company/baiustcomputerclub"><i class="fab fa-linkedin"></i>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row nav-row">
                <div class="col-lg-3 col-md-12 logo">
                    <a href="index.html">
                        <img src="assets/images/logo.png" alt="bcc">
                ...
                <div id="menu" class="col-lg-9 col-md-12 d-none d-lg-block nav-col">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="panel.html">Executive Panels</a>
                                </li>
...
<div class="page-nav no-margin row">
        <div class="container">
            <div class="row">
                <h2>Fall-2022 Membership Registration</h2>
            </div>
        </div>
    </div>
...
<br>
    ...
    <div class="controls">
    <input type="text" class="span4" name="dept" id="inputEmail" placeholder="Department" required>
    </div>
    </div>
    ...
    <div class="control-group">
    <div class="controls">
    <button type="submit" name="submit" class="btn btn-primary"><i class="icon-save icon-large"></i> Register</button>
    </div>
    </div>
    </form>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 map-img">
                ...
                <address class="md-margin-bottom-40">
                    BAIUST Computer Club <br>
                    Cumilla Cantonment <br>
                    Cumilla <br>
                    Phone: +8801784-337547<br>
                    Email: <a href="mailto:computerclub@baiust.edu.bd" class="">computerclub@baiust.edu.bd</a><br>
                </address>
...
<script src="assets/js/script.js"></script>
	...
	mysqli_query($conn,"INSERT into reg_member (fullname, uid, gender, dept, session, admityr, email, c_number, date)
	values('$fullname', '$uid', '$gender', '$dept', '$session', '$admityr', '$email', '$c_number', NOW())
	")or die(mysqli_error());
	?>
